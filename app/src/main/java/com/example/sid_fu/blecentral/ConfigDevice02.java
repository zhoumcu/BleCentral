 ...
 */
public class ConfigDevice02 extends ActionBarActivity implements View.OnClickListener{
        ...
        bottomleft_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(bottomleft_next.getText().equals("跳过"))
                {
                    ...
                    intent.setClass(ConfigDevice02.this,HomeActivity.class);
                    startActivity(intent);
                    finish();
                    new DeviceDao(ConfigDevice02.this).add(deviceDate);
...
//            currentPb.setVisibility(View.GONE);
    ...
    private Handler handler = new Handler()
    {
        ...
        public void handleMessage(Message msg) {
            ...
            Logger.e("重试");
            loadDialog.dismiss();
            Intent it =new Intent(ConfigDevice02.this,NotifyDialog.class);
            it.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
            startActivityForResult(it,NOTIFY_REQUEST_CODE);
            switch (msg.what)
            {
                case 1:
...
//        handler.removeCallbacks(runnable);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_ENABLE_BT ) {
            ...
            Logger.e("result");
        } else if(requestCode == NOTIFY_REQUEST_CODE){
            if(resultCode==100)
            {
                Logger.e("100");
