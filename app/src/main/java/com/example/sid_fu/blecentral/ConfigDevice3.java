 ...
 */
public class ConfigDevice3 extends ActionBarActivity implements View.OnClickListener{
        ...
        bottomleft_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(bottomleft_next.getText().equals("跳过"))
                {
                    ...
                    intent.setClass(ConfigDevice3.this,HomeActivity.class);
                    startActivity(intent);
                    finish();
                    new DeviceDao(ConfigDevice3.this).add(deviceDate);
...
//                mBluetoothAdapter.stopLeScan(mLeScanCallback);
    ...
    private Handler handler = new Handler()
    {
        ...
        public void handleMessage(Message msg) {
            ...
            Logger.e("重试");
            loadDialog.dismiss();
            Intent it =new Intent(ConfigDevice3.this,NotifyDialog.class);
        ...
        public void onReceive(Context context, final Intent intent) {
            ...
            if (BluetoothLeService.ACTION_GATT_CONNECTED.equals(action)) {
                ...
                if(state==5)
                {
                    ...
                    intentH.setClass(ConfigDevice3.this,HomeActivity.class);
